        ...
        <div className="flex flex-col gap-4 sm:flex-row">
          ...
          <div className="flex-1">
            <div className="mb-2 flex flex-wrap items-start justify-between gap-2">
              <div>
                <h3 className="text-lg font-semibold text-card-foreground">{lawyer.name}</h3>
              ...
              <div className="flex items-center gap-1 rounded-full bg-accent/10 px-2 py-1">
                ...
                <span className="text-sm text-muted-foreground">({lawyer.reviewCount})</span>
              </div>
            </div>
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <Button variant="outline" asChild>
                <Link href={`/lawyers/${lawyer.id}?book=true`}>Book Appointment</Link>
              </Button>
            </div>
          </div>
        </div>
